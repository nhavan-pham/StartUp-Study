...
void TFT_22_ILI9225::clear_cus() {
    uint8_t old = _orientation;
    setOrientation(0);
    delay(5);
    fillRectangle(30, 30, 140, 150, COLOR_BLACK);
    delay(5);
    setOrientation(old);
    delay(5);
}
...
void TFT_22_ILI9225::fillRectangle_cus(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t color) {
